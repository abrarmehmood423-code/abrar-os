...
export const starterData: AppData = {
  ...
  responsibilities: [
    {
      id: "resp-medicine",
      title: "Take transplant medicines on time",
      area: "Health",
      owner: "Abrar",
      frequency: "Daily",
      priority: "Critical",
      nextAction: "Add full medicine schedule",
      nextDate: today(),
      active: true,
      createdAt: now(),
    },
    {
      id: "resp-debt",
      title: "Pay every minimum debt payment",
      area: "Money",
      owner: "Abrar",
      frequency: "Monthly",
      priority: "Critical",
      nextAction: "Add cards, loans and due dates",
      nextDate: today(),
      active: true,
      createdAt: now(),
    },
    {
      id: "resp-immigration",
      title: "Maintain family immigration compliance",
      area: "Immigration",
      owner: "Abrar",
      frequency: "Monthly review",
      priority: "High",
      nextAction: "Add visa and passport expiry dates",
      nextDate: today(),
      active: true,
      createdAt: now(),
    },
    {
      id: "resp-level7",
      title: "Complete Level 7 coursework",
      area: "Education",
      owner: "Abrar",
      frequency: "Weekly",
      priority: "High",
      nextAction: "Add current assignment deadline",
      nextDate: today(),
      active: true,
      createdAt: now(),
    },
...
function migrate(value: Partial<AppData>): AppData {
  const tasks: Task[] = (value.tasks ?? []).map((task) => ({
    ...task,
